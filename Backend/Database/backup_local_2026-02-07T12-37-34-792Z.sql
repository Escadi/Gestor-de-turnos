...
-- Generated at: 2026-02-07T12:37:33.032Z
...
INSERT INTO `login` (`idWorker`, `username`, `password`, `role`) VALUES (4, NULL, '$2b$10$FkpD8haUiwZN2kePAKlqFeDIVoQNKAxDh2k5hGlcpOOnZAkippjfO', 'boss');
...
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (1, 'Informatica', 'Empleado', NULL, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (2, 'Director de Hotel', 'Dirección', NULL, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (3, 'Subdirector de Hotel', 'Dirección', 2, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (4, 'Jefe de Relaciones Publicas', 'Supervisor', 3, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (5, 'Relaciones Publicas', 'Empleado', 4, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (6, 'Jefe de Recepción', 'Supervisor', NULL, 0);
...
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (11, 'Gobernanta', 'Supervisor', NULL, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (12, 'Subgobernanta', 'Supervisor', NULL, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (13, 'Camarera de Pisos', 'Empleado', 11, 0);
...
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (16, 'Maitre', 'Supervisor', NULL, 0);
...
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (20, 'Jefe de Cocina', 'Supervisor', NULL, 0);
...
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (23, 'Jefe de Mantenimiento', 'Empleado', NULL, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (24, 'Técnico de Mantenimiento', 'Empleado', NULL, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (25, 'Jefe de Animación', 'Empleado', NULL, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (26, 'Animador', 'Empleado', NULL, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (27, 'Responsable Comercial', 'Empleado', NULL, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (28, 'Community Manager', 'Empleado', NULL, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (29, 'Responsable de RRHH', 'Jefe de Administración', NULL, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (30, 'Jefe de Administración', 'Supervisor', NULL, 0);
INSERT INTO `nameFuction` (`id`, `nameCategory`, `accessLevel`, `parentId`, `order`) VALUES (31, 'Administrativo', 'Empleado', NULL, 0);
...
CREATE TABLE `request` (
  ...
  KEY `idWorker` (`idWorker`),
  KEY `idType` (`idType`),
  CONSTRAINT `request_ibfk_49` FOREIGN KEY (`idWorker`) REFERENCES `worker` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `request_ibfk_50` FOREIGN KEY (`idType`) REFERENCES `requestType` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;
...
CREATE TABLE `sanctions` (
  ...
  KEY `idWorker` (`idWorker`),
  CONSTRAINT `sanctions_ibfk_49` FOREIGN KEY (`idSanctions`) REFERENCES `shifts` (`id`),
  CONSTRAINT `sanctions_ibfk_50` FOREIGN KEY (`idWorker`) REFERENCES `worker` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `shifts` (
  ...
  KEY `idWorker` (`idWorker`),
  KEY `idTimes` (`idTimes`),
  CONSTRAINT `shifts_ibfk_49` FOREIGN KEY (`idTimeShift`) REFERENCES `timeShifts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `shifts_ibfk_50` FOREIGN KEY (`idWorker`) REFERENCES `worker` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `shifts_ibfk_51` FOREIGN KEY (`idTimes`) REFERENCES `timeShifts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `worker` (
  ...
  CONSTRAINT `worker_ibfk_73` FOREIGN KEY (`idFuction`) REFERENCES `nameFuction` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `worker_ibfk_74` FOREIGN KEY (`idStatus`) REFERENCES `status` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `worker_ibfk_75` FOREIGN KEY (`idDepartament`) REFERENCES `departament` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;

-- Dumping data for table `worker`
INSERT INTO `worker` (`id`, `name`, `surname`, `dni`, `registrationDate`, `phoneNumber`, `idFuction`, `idStatus`, `locked`, `imageUrl`, `idDepartament`, `email`) VALUES (1, 'Carlos', 'Romero Díaz', '12345678A', '2023-01-15 09:00:00', '612345678', 1, 1, 0, NULL, 1, 'carlos.romero@hotel.com');
INSERT INTO `worker` (`id`, `name`, `surname`, `dni`, `registrationDate`, `phoneNumber`, `idFuction`, `idStatus`, `locked`, `imageUrl`, `idDepartament`, `email`) VALUES (2, 'María', 'González Pérez', '98765432B', '2023-02-20 10:30:00', '622334455', 7, 1, 0, NULL, 3, 'maría.gonzález@hotel.com');
INSERT INTO `worker` (`id`, `name`, `surname`, `dni`, `registrationDate`, `phoneNumber`, `idFuction`, `idStatus`, `locked`, `imageUrl`, `idDepartament`, `email`) VALUES (3, 'Lucía', 'Martín López', '45678912C', '2023-03-12 08:45:00', '633556677', 5, 1, 0, NULL, 3, 'lucía.martín@hotel.com');
INSERT INTO `worker` (`id`, `name`, `surname`, `dni`, `registrationDate`, `phoneNumber`, `idFuction`, `idStatus`, `locked`, `imageUrl`, `idDepartament`, `email`) VALUES (4, 'Javier', 'Santos León', '11223344D', '2023-04-03 14:20:00', '644998877', 4, 1, 0, NULL, 3, 'javier.santos@hotel.com');
INSERT INTO `worker` (`id`, `name`, `surname`, `dni`, `registrationDate`, `phoneNumber`, `idFuction`, `idStatus`, `locked`, `imageUrl`, `idDepartament`, `email`) VALUES (5, 'Elena', 'Suárez Medina', '99887766E', '2023-04-10 12:15:00', '655221133', 21, 1, 0, NULL, 5, 'elena.suárez@hotel.com');
INSERT INTO `worker` (`id`, `name`, `surname`, `dni`, `registrationDate`, `phoneNumber`, `idFuction`, `idStatus`, `locked`, `imageUrl`, `idDepartament`, `email`) VALUES (6, 'Daniel', 'Hernández Vega', '55667788F', '2023-05-05 09:05:00', '666112233', 10, 1, 0, NULL, NULL, 'daniel.hernández@hotel.com');
INSERT INTO `worker` (`id`, `name`, `surname`, `dni`, `registrationDate`, `phoneNumber`, `idFuction`, `idStatus`, `locked`, `imageUrl`, `idDepartament`, `email`) VALUES (7, 'Fernando', 'Díaz Marrero', '33445566G', '2023-06-07 16:40:00', '677445566', 20, 1, 0, NULL, 5, 'fernando.díaz@hotel.com');
INSERT INTO `worker` (`id`, `name`, `surname`, `dni`, `registrationDate`, `phoneNumber`, `idFuction`, `idStatus`, `locked`, `imageUrl`, `idDepartament`, `email`) VALUES (8, 'Laura', 'Benítez Ruiz', '22334455H', '2023-06-21 11:50:00', '688778899', 23, 1, 0, NULL, 7, 'laura.benítez@hotel.com');
INSERT INTO `worker` (`id`, `name`, `surname`, `dni`, `registrationDate`, `phoneNumber`, `idFuction`, `idStatus`, `locked`, `imageUrl`, `idDepartament`, `email`) VALUES (9, 'Ainhoa', 'Ramírez Torres', '88776655J', '2023-07-01 07:30:00', '699887766', 27, 1, 0, NULL, 9, 'ainhoa.ramírez@hotel.com');
INSERT INTO `worker` (`id`, `name`, `surname`, `dni`, `registrationDate`, `phoneNumber`, `idFuction`, `idStatus`, `locked`, `imageUrl`, `idDepartament`, `email`) VALUES (10, 'Pablo', 'Castro Morales', '44556677K', '2023-07-15 13:10:00', '611223344', 20, 1, 0, NULL, 5, 'pablo.castro@hotel.com');
INSERT INTO `worker` (`id`, `name`, `surname`, `dni`, `registrationDate`, `phoneNumber`, `idFuction`, `idStatus`, `locked`, `imageUrl`, `idDepartament`, `email`) VALUES (11, 'admin', 'admin', '00000000X', '2026-01-23 10:00:00', '000000000', 1, 1, 0, NULL, 1, 'admin.admin@hotel.com');
